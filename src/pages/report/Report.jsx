    ...
    axios
      ...
      .then((res) => {
        if (
          ...
          if (penaltys.length > 0 && !initialPenaltyNo) {
    ...
    <Modal isOpen={isOpen} onClose={handleCloseModal}>
      <ReportContainer>
        ...
        <ReportForm>
          ...
          <ReportTextArea value={reportNo} rows="1" readOnly />
        </ReportForm>

        <ReportForm>
          <ReportLabel>리뷰 번호:</ReportLabel>
          <ReportTextArea value={reviewNo} rows="1" readOnly />
        </ReportForm>
